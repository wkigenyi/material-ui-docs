...
>(function StoreTemplateLink({ brand, ...props }, ref) {
  return (
    ...
    >
      ...
      >
        <Typography fontWeight="bold">Book A Demo</Typography>
...
>(function StoreTemplateImage({ brand, ...props }, ref) {
  return (
    <Image
      ref={ref}
      src={`/static/branding/bankayo/products/savingsproduct/savings-${
      ...
      sx={(theme) =>
        theme.applyDarkStyles({
          content: `url(/static/branding/bankayo/products/savingsproduct/savings-${
            Object.keys(linkMapping).indexOf(brand) + 1
          }-dark.png)`,
        })
      }
...
export function PrefetchSavingsProductImages() {
  function makeImg(mode: string, num: number) {
    return {
      loading: 'lazy' as const,
      width: '900',
      height: '494',
      src: `/static/branding/bankayo/products/savingsproduct/savings-${num}-${mode}.png`,
    };
  }
  return (
    <Box
...
export default function SavingsProductShowCasing() {
  return (
    <Box
      sx={{
        mx: { xs: -2, sm: -3, md: 0 },
